...
class ApiMenuUserController extends Controller
{
    ...
    {
        $setting_menu_user = SettingMenuUser::with(['jenisUser', 'menu', 'createdBy'])->get();
    ...
    {
        $setting_menu_user = SettingMenuUser::with('createdBy')->find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($setting_menu_user) {
            ...
            // $setting_menu_user->create_by = $request->create_by;
