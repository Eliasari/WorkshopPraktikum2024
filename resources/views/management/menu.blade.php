...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css" />
                        ...
                        <div class="modal-body">
                            <form id="editMenuForm">
                                ...
                                <div class="form-group">
                                    <label for="edit_id_level">Levels</label>
                                    <select class="form-control" id="edit_id_level">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="createMenuForm">
                                ...
                                <div class="form-group">
                                    <label for="create_id_level">Level</label>
                                    <select class="form-control" id="create_id_level" name="create_id_level" required>
                                        <!-- Data jenis user akan diisi secara dinamis -->
                                    </select>
                                </div>
    ...
    <script>
        $(document).ready(function() {
                        ...
                        if (response.status === 'success') {
                            ...
                            $.each(menu, function(index, item) {
                                ...
                                <tr>
                                    ...
                                    <td><p class="text-sm font-weight-bold mb-0">${item.create_by}</p></td>
                                        <td>
            ...
            function loadLevels() {
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/menu/level',
                    type: 'GET',
                    success: function(response) {
                        if (response.status === 'success') {
                            var levels = response.data;
                            var selectEdit = $('#edit_id_level');
                            var selectCreate = $('#create_id_level');

                            selectEdit.empty();
                            selectCreate.empty();

                            $.each(levels, function(index, menu_level) {
                                selectEdit.append('<option value="' + menu_level.id_level +
                                    '">' + menu_level.level + '</option>');
                                selectCreate.append('<option value="' + menu_level.id_level +
                                    '">' + menu_level.level + '</option>');
                            });
                        } else {
